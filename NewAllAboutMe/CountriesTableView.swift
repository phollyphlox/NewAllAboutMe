...
//The array that will hold the names of the countries you have
//visited will need to be in the global section so that the 
//other views can see it.
var countries = ["Italy", "England", "Norway", "Spain"]
